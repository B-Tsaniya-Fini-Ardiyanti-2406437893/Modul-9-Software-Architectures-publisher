...
fn main() {
    ...
    _ = p.publish_event(
        ...
        UserCreatedEventMessage {
            user_id: "1".to_owned(),
            user_name: "2406437893-Amir".to_owned(),
        },
    );
    ...
    _ = p.publish_event(
        ...
        UserCreatedEventMessage {
            user_id: "2".to_owned(),
            user_name: "2406437893-Budi".to_owned(),
        },
    );
    ...
    _ = p.publish_event(
        ...
        UserCreatedEventMessage {
            user_id: "3".to_owned(),
            user_name: "2406437893-Cica".to_owned(),
        },
    );
    ...
    _ = p.publish_event(
        ...
        UserCreatedEventMessage {
            user_id: "4".to_owned(),
            user_name: "2406437893-Dira".to_owned(),
        },
    );
    ...
    _ = p.publish_event(
        ...
        UserCreatedEventMessage {
            user_id: "5".to_owned(),
            user_name: "2406437893-Emir".to_owned(),
        },
    );
}